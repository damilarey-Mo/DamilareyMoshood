import{r as S,j as m,b as Ke}from"./jsx-runtime-CbkKSL4Y.js";import{c as ve,a as $,b as N,m as U,t as v,I as Re,H as ie,B as le,T as Je,n as ue}from"./heading-CfEO2tZu.js";import{D as Ge}from"./decoder-text-C3ViJdb5.js";import{D as We}from"./divider-6sEWVpq6.js";import{b as Ye,S as Qe,F as Ze}from"./meta-C8hbQTtS.js";import{m as et,z as C,A as H,B as tt,C as rt,D as Ee,F as G,G as nt,H as P,I as at,J as O,U as W,K as st,N as z,P as Ce,Q as Z,T as ot,V as it,W as lt,X as ce,Y as de,E as ut,Z as ct,$ as dt,a0 as ft,a1 as ht,a2 as ke,a3 as mt,a4 as pt,a5 as gt,a6 as yt,a7 as wt,w as _t,a8 as bt}from"./components-9H2D2WkA.js";import"./visually-hidden-B3pZtuDi.js";import"./use-spring-odrDmNbQ.js";import"./index-CDQe8pgS.js";import"./config-DohaZlFR.js";/*!
 * cookie
 ...
 *
 * @license MIT
 */const yr=Object.freeze(Object.defineProperty({__proto__:null,MaxPartSizeExceededError:Le,UNSAFE_SingleFetchRedirectSymbol:ke,broadcastDevReady:tr,createCookieFactory:Dt,createCookieSessionStorageFactory:mr,createMemorySessionStorageFactory:pr,createRequestHandler:sr,createSession:re,createSessionStorageFactory:hr,defer:mt,isCookie:ee,isSession:fr,json:H,logDevReady:rr,redirect:Ee,redirectDocument:pt,replace:gt,unstable_composeUploadHandlers:Vt,unstable_createMemoryUploadHandler:gr,unstable_data:yt,unstable_parseMultipartFormData:Kt,unstable_setDevServerHooks:nr},Symbol.toStringTag,{value:"Module"}));function be(e=""){const[t,n]=S.useState(e),[r,a]=S.useState(),[s,i]=S.useState(!1);return{value:t,error:r,onChange:u=>{n(u.target.value),i(!0),r&&u.target.checkValidity()&&a(null)},onBlur:u=>{s&&u.target.checkValidity()},onInvalid:u=>{u.preventDefault(),a(u.target.validationMessage)}}}const wr="_textarea_1ly3z_2",_r={textarea:wr},br=({className:e,resize:t="none",value:n,onChange:r,minRows:a=1,maxRows:s,...i})=>{const[o,l]=S.useState(a),[c,u]=S.useState(),p=S.useRef();S.useEffect(()=>{const d=getComputedStyle(p.current),y=parseInt(d.lineHeight,10),h=parseInt(d.paddingTop,10)+parseInt(d.paddingBottom,10);u({lineHeight:y,paddingHeight:h})},[]);const f=d=>{r(d);const{lineHeight:y,paddingHeight:h}=c,R=d.target.rows;d.target.rows=a;const b=~~((d.target.scrollHeight-h)/y);b===R&&(d.target.rows=b),s&&b>=s&&(d.target.rows=s,d.target.scrollTop=d.target.scrollHeight),l(s&&b>s?s:b)};return m.jsx("textarea",{className:ve(_r.textarea,e),ref:p,onChange:f,style:$({resize:t}),rows:o,value:n,...i})},Sr="_container_1ukhq_2",xr="_content_1ukhq_16",vr="_input_1ukhq_21",Rr="_root_1ukhq_1",Er="_underline_1ukhq_55",Cr="_label_1ukhq_73",kr="_error_1ukhq_95",Tr="_errorMessage_1ukhq_111",k={container:Sr,content:xr,input:vr,root:Rr,underline:Er,label:Cr,error:kr,errorMessage:Tr},J=({id:e,label:t,value:n,multiline:r,className:a,style:s,error:i,onBlur:o,autoComplete:l,required:c,maxLength:u,type:p,onChange:f,name:d,...y})=>{const[h,R]=S.useState(!1),b=S.useId(),g=S.useRef(),_=e||`${b}input`,x=`${_}-label`,D=`${_}-error`,Xe=r?br:"input",Be=A=>{R(!1),o&&o(A)};return m.jsxs("div",{className:ve(k.container,a),"data-error":!!i,style:s,...y,children:[m.jsxs("div",{className:k.content,children:[m.jsx("label",{className:k.label,"data-focused":h,"data-filled":!!n,id:x,htmlFor:_,children:t}),m.jsx(Xe,{className:k.input,id:_,"aria-labelledby":x,"aria-describedby":i?D:void 0,onFocus:()=>R(!0),onBlur:Be,value:n,onChange:f,autoComplete:l,required:c,maxLength:u,type:p,name:d}),m.jsx("div",{className:k.underline,"data-focused":h})]}),m.jsx(N,{unmount:!0,in:i,timeout:U(v.base.durationM),children:({visible:A,nodeRef:Ve})=>{var oe;return m.jsx("div",{ref:Ve,className:k.error,"data-visible":A,id:D,role:"alert",style:$({height:A?(oe=g.current)==null?void 0:oe.getBoundingClientRect().height:0}),children:m.jsxs("div",{className:k.errorMessage,ref:g,children:[m.jsx(Re,{icon:"error"}),i]})})}})]})};var jr={},ne={},j={};const $e=Ke(yr);var X={};/**
 ...
 *
 * @license MIT
 */Object.defineProperty(j,"__esModule",{value:!0});var B=$e,Se=X;const se=B.createCookieFactory({sign:Se.sign,unsign:Se.unsign}),Hr=B.createCookieSessionStorageFactory(se),qe=B.createSessionStorageFactory(se),Ar=B.createMemorySessionStorageFactory(qe);j.createCookie=se;j.createCookieSessionStorage=Hr;j.createMemorySessionStorage=Ar;j.createSessionStorage=qe;/**
 * @remix-run/cloudflare v2.12.1
 *
 * Copyright (c) Remix Software Inc.
 *
